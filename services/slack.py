            ...
            *([
            ...
            },
            {
                ...
                "hint": {"type": "plain_text",
                         "text": ("위 To-do 목록 외에 추가로 완료한 업무가 있다면 적어주세요." if not is_new else "Task의 '완료된' To-do로 자동 생성됩니다.")},
                "element": {
                    "type": "plain_text_input",
                    "action_id": f"completed_{step}",
                    "multiline": True,
            ...
            },
            {
                ...
                "optional": True,
                "label": {"type": "plain_text", "text": "🔜 내일 예정 (신규 To-do 추가)"},
                "hint": {"type": "plain_text",
                         "text": "내일 할 업무를 적어주세요. Task의 미완료 'To-do'로 새롭게 추가됩니다."},
                "element": {
                    "type": "plain_text_input",
                    "action_id": f"tomorrow_{step}",
                    "multiline": True,
                    "placeholder": {"type": "plain_text",
